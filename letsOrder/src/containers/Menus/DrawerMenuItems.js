  ...
  <ScrollView style={{ marginTop: 20, flexGrow: 1, flexDirection: 'column' }}>
    {
                props.navigation.state.routes.length ? (
                    props.navigation.state.routes.map((route, number) => (
                      ...
                      >
                        <View style={{
 flexDirection: 'row', justifyContent: 'flex-start', marginTop: 30, marginLeft: width / 8,
}}
                        >
                          <Text style={{
 fontSize: 20, color: '#1874CD', fontFamily: 'AppleSDGothicNeo-SemiBold', textAlign: 'center',
}}
                          >
