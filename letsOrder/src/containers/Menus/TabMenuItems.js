            ...
            props.navigation.state.routes.length ? (
                props.navigation.state.routes.map((route, number) => {
                    ...
                    return (
                      ...
                      >
                        <View style={{
 marginLeft: 20, marginTop: height / 40, shadowOpacity: 25, alignSelf: 'flex-start',
}}
                        >
                          <Text
                            adjustsFontSizeToFit
                            style={{
borderRadius: 5, fontWeight: 'bold', borderWidth: 2, paddingTop: 5, color: 'white', height: height / 18, width: width / 5, textAlign: 'center', backgroundColor: focused, borderStyle: 'dashed',
}}
                          >
